...
@Autonomous(name = "Pedro Example", group = "autonomous")
public class PedroExample extends OpMode {
    ...
    private final Pose strafeto1Pose = new Pose(30,37, Math.toRadians(90));

    // private final Pose turn180Pose = new Pose(30,37, Math.toRadians(180));
    private final Pose lineto1Pose = new Pose(56,40, Math.toRadians(90));
    //private final Pose moveto1Pose = new Pose(59, 36, Math.toRadians(0)); // Lining up for sample with beziure curve idk how to spell
    private final Pose linewithsamp1Pose = new Pose(62,28, Math.toRadians(90)); // Strafing to line up with sample again b4 pushing to human player zone
